...
| <a name="input_org_integration"></a> [org\_integration](#input\_org\_integration) | Boolean to determine if the Service Account should have Organization Level Permissions. | `bool` | `false` | no |
